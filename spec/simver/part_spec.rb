...
describe Simver::Part do
  ...
  describe '.new' do
    ...
    it "sets #parts to a list of the dot-separated components provided in the +part+ parameter" do
      Simver::Part.new("1.2.3").parts.should == %w{ 1 2 3 }
    end

    it "sets #original to the string version of the provided +part+ parameter" do
      Simver::Part.new("3.2.01").original.should == "3.2.01"
    end
  ...
  describe '#original' do
    ...
    it "returns a frozen string" do
      Simver::Part.new("3.2.01").original.should be_frozen
    end

  end # describe '#original'
